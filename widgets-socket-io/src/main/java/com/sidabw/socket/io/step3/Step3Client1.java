 ...
 */
@Slf4j
public class Step3Client1 {

    private static final org.slf4j.Logger LOGGER = LoggerFactory.getLogger(Step3Client1.class);

    public static void main(String[] args) throws URISyntaxException, InterruptedException {
        IO.Options options = new IO.Options();
        Socket socketClient = IO.socket("http://127.0.0.1:9092/chat1", options);
        //连接成功监听事件
