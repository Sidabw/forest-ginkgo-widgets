...
import static com.sidabw.socket.io.step3.Step3ServerOfNamespace.*;
 ...
 */
@Slf4j
public class Step3Client4 {

    private static final org.slf4j.Logger LOGGER = LoggerFactory.getLogger(Step3Client4.class);

    public static void main(String[] args) throws URISyntaxException, InterruptedException {
        IO.Options options = new IO.Options();
        Socket socketClient = IO.socket("http://localhost:9092" + NAMESPACE2, options);
        //连接成功监听事件
